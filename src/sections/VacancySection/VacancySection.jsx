...
const VacancySection = () => {
  ...
  return (
    <Section className={"vacancy-section"}>
      <h2 className="vacancy-section-title">
        Hundreds of Jobs From All Over the Globe
      </h2>
      <div className="vacancy-section-list">
        {vacancies.map((item) => {
          return (
            <Link className="vacancy-item" key={item.id} to={item.href}>
              <div className="vacancy-item-image-bg">
                <Image className="vacancy-item-image" src={item.src} />
              </div>
              <div className="vacancy-item-desc">
                <div className="vacancy-item-desc-name">{item.name}</div>
                <div className="vacancy-item-desc-company">
                  <b>{item.company}</b>
                </div>
              </div>
              <div className="vacancy-item-region">{item.region}</div>
            </Link>
          );
        })}
      </div>
